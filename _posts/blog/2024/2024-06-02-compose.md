...
- [painterresource](https://developer.android.com/reference/kotlin/androidx/compose/ui/res/package-summary#painterresource) API를 사용하여 PNG, JPEG, WEBP, 벡터 리소스를 로드 가능
  - painterResource에서 제공하는 타입
    ...
    - [VectorDrawable](https://developer.android.com/develop/ui/compose/graphics/images/loading)
...
>
> - 밀도와 화면 크기에서 항목의 크기를 일관되게 유지하려면 [`.toPx()`](https://developer.android.com/reference/kotlin/androidx/compose/ui/unit/Density#(androidx.compose.ui.unit.Dp).toPx())를 사용하여 `dp`에서 변환하거나 크기의 비율로 작업
...
[`TextMeasurer`](https://developer.android.com/reference/kotlin/androidx/compose/ui/text/TextMeasurer)를 사용하여 텍스트 크기에 접근 가능.
...
`DrawScope`로 [`ImageBitmap`](https://developer.android.com/reference/kotlin/androidx/compose/ui/graphics/ImageBitmap)을 그리려면 `ImageBitmap.imageResource()`를 사용하여 이미지를 로드한 다음 `drawImage`를 호출
...
[`Modifier.drawBehind`](https://developer.android.com/reference/kotlin/androidx/compose/ui/draw/package-summary#(androidx.compose.ui.Modifier).drawBehind(kotlin.Function1))를 사용하여 Composable 컨텐츠 뒤에 `DrawScope` 작업을 실행
...
[`Modifier.drawWithCache`](https://developer.android.com/reference/kotlin/androidx/compose/ui/draw/package-summary#(androidx.compose.ui.Modifier).drawWithCache(kotlin.Function1))는 내부에서 생성된 객체를 캐시된 상태로 유지
